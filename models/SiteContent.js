...
const siteContentSchema = new mongoose.Schema({
  section: { type: String, required: true, unique: true }, // 'hero', 'services', 'dental', 'skincare', 'about', 'contactinfo', 'beforeafter'
  // Hero
  ...
  mapLink:  { type: String },
  // Before / After
  beforeAfterTitleBn: { type: String },
  beforeAfterTitleEn: { type: String },
  beforeAfterSubBn:   { type: String },
  beforeAfterSubEn:   { type: String },
  beforeAfterSliders: [{
    labelBn:     String,
    labelEn:     String,
    caseNo:      String,
